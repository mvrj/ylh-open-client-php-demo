...
if (!empty($_POST['mobile'])&& trim($_POST['mobile'])!=""){
...
<script language="javascript">
    document.getElementById("rcm_id").value =  'ylhadmin';
</script>
</html>